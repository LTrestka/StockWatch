...
public class AsynchAdd extends AsyncTask<String, Void, String> {
    ...
    public AsynchAdd(MainActivity ma) {
        mainActivity = ma;
    }

    @Override
    protected void onPostExecute(String x) {
        Log.d(TAG, "doInBackgroung: searched stock list generated");
        mainActivity.addStock(stockToAdd);
    }
